<div>
    <p class="font-semibold text-xs text-gray-400 mb-0.5">Settings</p>
    <ul>
        <li>
            <div class="flex items-center">
                <svg
                    ...
                    data-prefix="fas"
                    data-icon="user"
                    class="svg-inline--fa fa-user fa-w-14 w-4 h-4 mr-1"
                    role="img"
        ...
        <li>
            <div class="flex items-center">
                <svg
                    ...
                    data-prefix="fas"
                    data-icon="cog"
                    class="svg-inline--fa fa-cog fa-w-16 w-4 h-4 mr-1"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
