...
<div>
    ...
    <ul>
        <li>
            <a href="/dashboard/prescriptions" class="flex items-center">
                <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                    data-icon="capsules"
                    class="svg-inline--fa fa-capsules fa-w-18 w-4 h-4 mr-1"
                    role="img"
        ...
        <li>
            <a href="/dashboard/appointments" class="flex items-center">
