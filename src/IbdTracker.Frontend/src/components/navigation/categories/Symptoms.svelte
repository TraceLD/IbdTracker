<div>
    ...
    <ul>
        <li>
            <div class="flex items-center">
                <svg
                    ...
                    class="svg-inline--fa fa-exclamation-circle fa-w-16 w-4 h-4 mr-1"
                    role="img"
        ...
        <li>
            <a href="/dashboard/bms" class="flex items-center">
                <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                    data-icon="toilet"
                    class="svg-inline--fa fa-toilet fa-w-12 w-4 h-4 mr-1"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
